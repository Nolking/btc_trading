...
MODEL_OUTPUT_PATH = "../../models/rf_divergence_model.pkl"
META_OUTPUT_PATH = "../../models/rf_divergence_model_meta.json"
SIGNALS_OUTPUT_PATH = "../../models/rf_divergence_training_signals.csv"
...
# Optional validation on train set only
...
# =========================================================
# FEATURES
# RSI-only indicator features + raw price context
# =========================================================
...
# =========================================================
# PNL
# 0.05 lot => 1000 USD BTC move = 50 USD PnL
# pnl = price_change * 0.05
# =========================================================
...
def train_model(signals: pd.DataFrame, feature_columns: list):
    ...
    class_weight = "balanced" if minority > 0 else None
    ...
    if USE_INTERNAL_VALIDATION and len(signals) >= 50:
        ...
        # retrain on full training signals
        model.fit(X, y)
    else:
        model.fit(X, y)
